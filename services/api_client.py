...
def send_availability_request(
    ...
    try:
        payload = {
            "driverIds": ["pv258iLSjtfyBHyLgRjQcShJDt92", "NewcOnEO5DdiDkhKwc8LjGapICB3", "sHRv1ZZJ3pWKqH2yAo8OhRkwZPn2", "QKCrCXmknFc1ySeFrlwXUfCVYL93", "cJo7fYhvWGP8b9VZFvnEhtrG5g32", "ANsgKjXjvTMnHvcuJxeWYbQOxoo1"],
            "data": {
